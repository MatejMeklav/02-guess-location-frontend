...
export default function LocationAddLayout() {
  ...
  useEffect(() => {
    ...
    if (secureUrl) {
      ...
      axios
        .post(
          process.env.REACT_APP_BACKEND_SERVER_URL + "location/create",
          {
            image: imageUrl,
            latitude: latitude,
        ...
        <form id="form-image">
          <div className="image-show">
            <div className="input-container">
              ...
              {!showImage && width <= 500 ? (
                <img
                  src={require("../Images/placeholder-image-mobile.png")}
                  alt="uploaded file"
                ></img>
              ) : (
                ""
              ...
              {!showImage && width > 500 ? (
                <img
                  src={require("../Images/placeholder-image-add.png")}
                  alt="uploaded file"
                ></img>
              ) : (
                ""
            ...
            <div className="handle-file-upload">
              ...
              >
                <img
                  className="x-icon"
                  src={require("../Images/react-icon-x.png")}
                  alt="x-icon"
                ></img>
              </div>
            </div>
          ...
          <div className="submit">
            ...
            {locationCreated ? (
              <p id="loc-created">Location was created sucessfully</p>
            ) : (
              ""
            )}
