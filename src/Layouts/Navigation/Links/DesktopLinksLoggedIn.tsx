...
export default function DesktopLinksLoggedIn() {
  ...
  const createIcon = <svg className='svg-outside-desktop' width="40px" height="40px">
  <defs>
  ...
  <IconContext.Provider value={{ attr: {fill: "url('#gradient')"}}}>
    <AiFillPlusCircle className='create-circle' size={40} width='30px' height='30px' color="green"></AiFillPlusCircle>
